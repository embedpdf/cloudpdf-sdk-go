...
```go
response, err := client.Shares.Exchange(...)
if err != nil {
...
```go
response, err := client.Shares.WithRawResponse.Exchange(...)
if err != nil {
    return err
}
...
response, err := client.Shares.Exchange(ctx, ...)
```
...
response, err := client.Shares.Exchange(ctx, request, ...)
```
